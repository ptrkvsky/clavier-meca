        ...
        function (e, t, r) {
          (function (e) {
            (function () {
              ...
              function m(e) {
                return null == e ? p(e) : d.call(e).slice(8, -1);
              }
              function S(e) {
              ...
              var y = (function e(t) {
                ...
                var l,
                  ...
                  y = n
                    ...
                    : /\bChrome\b/.test(t) &&
                      !/internal|\n/i.test(d.toString()),
                  O = n ? "Object" : "ScriptBridgingProxyObject",
                  v = n ? "Object" : "Environment",
                  w = n && r.java ? "JavaPackage" : m(r.java),
                  E = n ? "Object" : "RuntimeObject",
                  M = /\bJava/.test(w) && r.java,
                  P = M && m(r.environment) == v,
                  C = M ? "a" : "α",
                  k = M ? "b" : "β",
                  R = r.document || {},
                  B = r.operamini || r.opera,
                  W = c.test((W = n && B ? B["[[Class]]"] : m(B)))
                    ? W
                    : (B = null),
                  I = t,
                  A = [],
                  T = null,
                  j = t == a,
                  F = j && B && "function" == typeof B.version && B.version(),
                  $ = g(
                    [
                    ...
                    function (e, r) {
                      return (
                        e ||
                        (RegExp("\\b" + (r.pattern || S(r)) + "\\b", "i").exec(
                          t
                        ) &&
                          (r.label || r))
                      );
                ...
                if (
                  ...
                  /\bAndroid\b/.test(K) &&
                    !N &&
                    (l = /\bAndroid[^;]*;(.*?)(?:Build|\) AppleWebKit)\b/i.exec(
                      t
                    )) &&
                    (N =
                  ...
                  (l = /\bGoogle TV\b/.exec(N)) && (N = l[0]),
                  /\bSimulator\b/i.test(t) &&
                    (N = (N ? N + " " : "") + "Simulator"),
                  "Opera Mini" == G &&
                    /\bOPiOS\b/.test(t) &&
                    A.push("running in Turbo/Uncompressed mode"),
                  "IE" == G && /\blike iPhone OS\b/.test(t)
                    ? ((X = (l = e(t.replace(/like iPhone OS/, "")))
                        .manufacturer),
                      (N = l.product))
                    : /^iP/.test(N)
                    ? (G || (G = "Safari"),
                      (K =
                        ...
                        ((l = / OS ([\d_]+)/i.exec(t))
                          ? " " + l[1].replace(/_/g, ".")
                          : "")))
                    : "Konqueror" == G && /^Linux\b/i.test(K)
                    ? (K = "Kubuntu")
                    : (X &&
                        "Google" != X &&
                        ((/Chrome/.test(G) && !/\bMobile Safari\b/i.test(t)) ||
                          /\bVita\b/.test(N))) ||
                      (/\bAndroid\b/.test(K) &&
                        /^Chrome/.test(G) &&
                        /\bVersion\//i.test(t))
                    ...
                    : "Silk" == G
                    ? (/\bMobi/i.test(t) ||
                        ((K = "Android"), A.unshift("desktop mode")),
                      /Accelerated *= *true/i.test(t) &&
                        A.unshift("accelerated"))
                    : "UC Browser" == G && /\bUCWEB\b/.test(t)
                    ? A.push("speed mode")
                    : "PaleMoon" == G && (l = /\bFirefox\/([\d.]+)\b/.exec(t))
                    ? A.push("identifying as Firefox " + l[1])
                    : "Firefox" == G && (l = /\b(Mobile|Tablet|TV)\b/i.exec(t))
                    ? (K || (K = "Firefox OS"), N || (N = l[1]))
                    : !G ||
                      (l =
                  ...
                  if (
                    ...
                    (M &&
                      ((I = (l = M.lang.System).getProperty("os.arch")),
                      (K =
                        K ||
                    ...
                    try {
                      (F = r.require("ringo/engine").version.join(".")),
                        (G = "RingoJS");
                    } catch (e) {
                      (l = r.system) &&
                        l.global.system == r.system &&
                        ((G = "Narwhal"), K || (K = l[0].os || null));
                    }
                    G || (G = "Rhino");
                  } else
                    "object" == typeof r.process &&
                      ...
                      ("object" == typeof l.versions &&
                        ("string" == typeof l.versions.electron
                          ? (A.push("Node " + l.versions.node),
                            (G = "Electron"),
                            (F = l.versions.electron))
                          : "string" == typeof l.versions.nw &&
                            (A.push("Chromium " + F, "Node " + l.versions.node),
                            (G = "NW.js"),
                            (F = l.versions.nw))),
                      G ||
                        ((G = "Node.js"),
                ...
                if (
                  ...
                  "Xbox 360" == N && (K = null),
                    "Xbox 360" == N &&
                      /\bIEMobile\b/.test(t) &&
                      A.unshift("mobile mode");
                else if (
                  (!/^(?:Chrome|IE|Opera)$/.test(G) &&
                    (!G || N || /Browser|Mobi/.test(G))) ||
                  ...
                  if ("IE" == G && j)
                    ...
                    (/\bBlackBerry\b/.test(N) || /\bBB10\b/.test(t)) &&
                    (l =
                      (RegExp(N.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(
                        t
                      ) || 0)[1] || F)
                      ? ((K =
                          ((l = [l, /BB10/.test(t)])[1]
                      ...
                      : this != h &&
                        ...
                        ((j && B) ||
                          ...
                          ("Firefox" == G && /\bOS X (?:\d+\.){2,}/.test(K)) ||
                          ("IE" == G &&
                            ((K && !/^Win/.test(K) && F > 5.5) ||
                              (/\bWindows XP\b/.test(K) && F > 8) ||
                              (8 == F && !/\bTrident\b/.test(t))))) &&
                        !c.test((l = e.call(h, t.replace(c, "") + ";"))) &&
                        l.name &&
                        ((l =
                          "ing as " +
                          l.name +
                ...
                (l = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(t) || 0)[1]) &&
                  ...
                  "Opera" == G && (l = /\bzbov|zvav$/.exec(K))
                    ...
                    ? (A.unshift("desktop mode"),
                      ...
                      /\bOS X\b/.test(K)
                        ? ((X = "Apple"), (K = "iOS 4.3+"))
                        : (K = null))
                    : /\bSRWare Iron\b/.test(G) && !F && (F = D("Chrome")),
                  F &&
                    0 == F.indexOf((l = /[\d.]+$/.exec(K))) &&
                    t.indexOf("/" + l + "-") > -1 &&
                    (K = x(K.replace(l, ""))),
                  K &&
                    -1 != K.indexOf(G) &&
                    !RegExp(G + " OS").test(K) &&
                    (K = K.replace(RegExp(" *" + S(G) + " *"), "")),
                  $ &&
                  ...
                  (l = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(I)) &&
                  !/\bi686\b/i.test(I)
                    ? (K &&
                        ((K.architecture = 64),
      ...
      2: [
        function (e, t, r) {
          ...
          Object.defineProperty(r, "__esModule", { value: !0 }),
            (r.create = r.detect = r.attributes = void 0);
          var n,
            i = (n = e("platform")) && n.__esModule ? n : { default: n };
          function o(e, t) {
            var r = Object.keys(e);
          ...
          var u = function (e, t, r, n) {
              ...
              i.open("POST", e),
                (i.onload = function () {
                  if (200 === i.status || 201 === i.status) {
                    ...
                    return null != e.errors
                      ? n(new Error(e.errors[0].message))
                      : n(null, e);
                  }
                  return n(
                    new Error("Server returned with an unhandled status")
                  );
                }),
                i.setRequestHeader(
                  "Content-Type",
                ...
                i.send(JSON.stringify({ query: t, variables: r }));
            },
            b = function (e, t, r, n, i) {
              ...
              u(
                ...
                function (e, t) {
                  ...
                  var r = t.data.createRecord.payload.id,
            ...
            d = function () {
              ...
              if (null != e) {
                var t = e.getAttribute("data-ackee-server") || "",
                  ...
                  n = e.getAttribute("data-ackee-opts") || "{}";
                p({ server: t, domainId: r }, JSON.parse(n)).record();
              }
            };
          r.detect = d;
          var p = function (e, t) {
